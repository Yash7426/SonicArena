    ...
    return (
      <section className="flex flex-col gap-y-7 bg-black text-white px-[5vw] font-poppins">
        <div>
          ...
          All your rewards are stored here.
          </p>
        </div>
        ...
        <div className="mb-10 font-bmps">
            ...
            <div className="text-white flex gap-2"><Image src="/images/account_balance_wallet.svg" width={25} height={25} alt="wallet"/> Wallet</div>
            </h3>
            ...
            <Image src="/images/sonic_big_logo.svg" alt="Sonic Token" width={90} height={90} className="mr-3"/>
            </div>
        </div>
